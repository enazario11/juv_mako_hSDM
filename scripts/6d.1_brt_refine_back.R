...
#saveRDS(dat_test_base_d, here("data/brt/mod_eval/back/base_test_daily.rds"))
...
#saveRDS(dat_test_base_s, here("data/brt/mod_eval/back/base_test_seasonal.rds"))
...
#saveRDS(dat_test_base_a, here("data/brt/mod_eval/back/base_test_annual.rds"))
...
#saveRDS(dat_test_do_d, here("data/brt/mod_eval/back/do_test_daily.rds"))
...
#saveRDS(dat_test_agi_d, here("data/brt/mod_eval/back/agi_test_daily.rds"))
...
#saveRDS(dat_test_do_all, here("data/brt/mod_eval/back/do_test_daily_seasonal_annual.rds"))
...
#saveRDS(dat_test_agi_all, here("data/brt/mod_eval/back/agi_test_daily_seasonal_annual.rds"))
...
#saveRDS(dat_test_do_agi_all, here("data/brt/mod_eval/back/agi_do_test_daily_seasonal_annual.rds"))

### Remove wind vars ####
# base model w/o wind vars
try(brt_base_0m_dail_no_wind <- dismo::gbm.step(
  data = dat_train_base_d, 
  gbm.x = c(7:9, 14:17, 19), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.1, 
...
saveRDS(brt_base_0m_dail_no_wind, here("data/brt/mod_outputs/background/refined/brt_base_0m_dail_no_wind.rds"))

#do reference model w/o wind vars
try(brt_do_0m_60m_250m_dail_seas_ann_no_wind <- dismo::gbm.step(
  data = dat_train_do_all, 
  gbm.x = c(7:10, 15:18, 20:28), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
...
saveRDS(brt_do_0m_60m_250m_dail_seas_ann_no_wind, here("data/brt/mod_outputs/background/refined/brt_do_0m_60m_250m_dail_seas_ann_no_wind.rds"))

#agi reference model w/o wind vars
try(brt_agi_0m_60m_250m_dail_seas_ann_no_wind <- dismo::gbm.step(
  data = dat_train_agi_all, 
  gbm.x = c(7:9, 14:18, 20:28), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
...
saveRDS(brt_agi_0m_60m_250m_dail_seas_ann_no_wind, here("data/brt/mod_outputs/background/refined/brt_agi_0m_60m_250m_dail_seas_ann_no_wind.rds"))
...
try(brt_agi_250_DO_0_dail_seas_ann <- dismo::gbm.step(
  ...
  gbm.x = c(7:9, 14:17, 21, 22, 25, 28:31), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
...
saveRDS(brt_agi_250_DO_0_dail_seas_ann, here("data/brt/mod_outputs/background/refined/brt_agi_250_DO_0_dail_seas_ann.rds"))
...
try(brt_do_0m_250m_dail_seas_ann <- dismo::gbm.step(
  data = dat_train_do_all, 
  gbm.x = c(7:10, 15:18, 21:23, 25, 26, 28), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
...
saveRDS(brt_do_0m_250m_dail_seas_ann, here("data/brt/mod_outputs/background/refined/brt_do_0m_250m_dail_seas_ann.rds"))

#DO removed seasonal res from reference model w/ all info
try(brt_do_0m_60m_250m_dail_ann <- dismo::gbm.step(
  data = dat_train_do_all, 
  gbm.x = c(7:10, 15:18, 20:22, 26:28), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
...
saveRDS(brt_do_0m_60m_250m_dail_ann, here("data/brt/mod_outputs/background/refined/brt_do_0m_60m_250m_dail_ann.rds"))

#DO removed daily res from reference model w/ all info
try(brt_do_0m_60m_250m_seas_ann <- dismo::gbm.step(
  data = dat_train_do_all, 
  gbm.x = c(8:10, 15:18, 22, 23:28), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
...
saveRDS(brt_do_0m_60m_250m_seas_ann, here("data/brt/mod_outputs/background/refined/brt_do_0m_60m_250m_seas_ann.rds"))

#DO removed seasonal res and 60m from reference model w/ all other info 
try(brt_do_0m_250m_dail_ann <- dismo::gbm.step(
  data = dat_train_do_all, 
  gbm.x = c(7:10, 15:18, 21, 22, 26, 28), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
...
saveRDS(brt_do_0m_250m_dail_ann, here("data/brt/mod_outputs/background/refined/brt_do_0m_250m_dail_ann.rds"))

#DO removed seasonal res and 60m from reference model, and removed 250m daily and 0m annual, w/ all other info 
try(brt_do_0m_250m_dail_ann_refined <- dismo::gbm.step(
  data = dat_train_do_all, 
  gbm.x = c(7:10, 15:18, 22, 28), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
...
saveRDS(brt_do_0m_250m_dail_ann_refined, here("data/brt/mod_outputs/background/refined/brt_do_0m_250m_dail_ann_refined.rds"))
...
saveRDS(brt_agi_0m_60m_250m_dail_ann, here("data/brt/mod_outputs/background/refined/brt_agi_0m_60m_250m_dail_ann.rds"))

#agi remove daily res from reference model w/ all info 
try(brt_agi_0m_60m_250m_seas_ann <- dismo::gbm.step(
  data = dat_train_agi_all, 
  gbm.x = c(7:9, 14:17, 22:28), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
...
saveRDS(brt_agi_0m_60m_250m_seas_ann, here("data/brt/mod_outputs/background/refined/brt_agi_0m_60m_250m_seas_ann.rds"))

#agi remove seasonal res and 60m from reference model w/ all info 
try(brt_agi_0m_250m_dail_ann <- dismo::gbm.step(
  data = dat_train_agi_all, 
  gbm.x = c(7:9, 14:18, 21, 22, 26, 28), 
  gbm.y = 5,
  family = "bernoulli", 
  tree.complexity = 3,
  learning.rate = 0.05, 
