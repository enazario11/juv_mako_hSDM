...
output_sum <- read.csv(here("data/brt/mod_outputs/brt_background_do_seas_ann_output_summary.csv"))
kableExtra::kable(output_sum)
```
...
output_sum <- read.csv(here("data/brt/mod_outputs/brt_background_agi_seas_ann_output_summary.csv"))
kableExtra::kable(output_sum)
```
