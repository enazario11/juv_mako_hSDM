...
# mod_type = as.factor(mod_type),
#                                       mod_type = fct_relevel(mod_type, c("Base model", "DO model", "AGI model", "DO, AGI combo model")),

# stat.tss <- mod_metrics %>%
#   wilcox_test(TSS ~ mod_type) %>%
...
TSS_plot <- dt_tss %>% mutate(mod_type = as.factor(mod_type), 
  ...
  geom_segment(aes(x=mod_type, xend=mod_type, y=0, yend=mean_tss), color="darkslategrey", linewidth = 1.5) +
...
AUC_plot <- dt_auc %>% mutate(mod_type = as.factor(mod_type), 
  ...
  geom_segment(aes(x=mod_type, xend=mod_type, y=0.7, yend=mean_auc), color="darkslategrey", linewidth = 1.5) +
  geom_point(color="orange", size=8) +
  theme_light() +
  theme(
    panel.grid.major.x = element_blank(),
...
perc_exp_plot <- dt_dev %>% mutate(mod_type = as.factor(mod_type), 
  ...
  geom_segment(aes(x=mod_type, xend=mod_type, y=20, yend=mean_dev), color="darkslategrey", linewidth = 1.5) +
  geom_point(color="orange", size=8) +
  theme_light() +
  theme(
    panel.grid.major.x = element_blank(),
...
TSS_plot|AUC_plot|perc_exp_plot
