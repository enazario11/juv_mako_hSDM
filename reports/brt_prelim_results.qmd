...
lessR::PieChart(x = Predictor_variable, y = relative_influence, data = do_inf, fill = do_cols, color = base_cols,  main = NULL, quiet = TRUE, cex = 2, labes_size = 1.5) 
...
lessR::PieChart(x = Predictor_variable, y = relative_influence, data = agi_inf, fill = agi_cols, color = base_cols, main = NULL, quiet= TRUE, cex = 2, labes_size = 1.5) 
...
mod_metrics <- output_sum %>% filter(model == "base_Nwind_crw" | model == "agi_0m_250m_dail_seas_ann_crw" | model == "do_0m_250m_dail_seas_ann_crw")
