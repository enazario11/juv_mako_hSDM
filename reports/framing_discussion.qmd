...
![AGI at 250m across ENSO phases. Percent areas represent the proportion of area with AGI values \< 1 and are outlined in black.](images/agi_maps-03.png){fig-align="center"}

-   ***Question***: Change color scale because inverse of HSI map scales? Wanted red to represent low-DO areas, but in other maps, red represents high suitability habitats. Thoughts on modifying this?
...
-   ***Question***: Thoughts on including difference maps instead for the LN and EN years to better show changes in habitat suitability relative to the neutral year?
...
-   Different ENSO phases have also altered habitat suitability and species distributions in the CCS. Here, metabolically unsuitable habitat (AGI \< 1) expanded by 2.5% when comparing a normal to LN year, and as these phases are anticipated to become more extreme with climate change, may result in bigger sways of habitat contractions. Additionally, AGI reductions during LN conditions were observed, providing a preview of possible habitat loss as ocean deoxygenation intensifies under anticipated climate change scenarios.
    ...
    -   During the 2014 EN season, all models picked up a decline in habitat suitability, with the two models considering DO showing the largest contractions (\~1.8%). Generally, areas of high habitat suitability seem patchier, and generally cover similar distributions as the neutral year, but limited to the core areas of highest suitability (high habitat suitability patches shrinking when comparing neutral year to EN year). Here, the base model captured declines, but still predicted large areas of moderate habitat suitability, while other models predicted more focused regions. Improved ecological realism of habitat predictions could be due to chlorophyll and temperature being considered across all models, while mixed success during the LN year could be due to DO/AGI not being equally considered across models. May suggest that different model types that consider different features may be necessary for prediction during different conditions/seasons?
