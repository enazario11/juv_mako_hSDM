...
#### HSI map of above but without lat and DOY
```{r}
#| warning: FALSE
try(agi_tc7_lr01_nolat <- dismo::gbm.step(data = dat_train,
                                    gbm.x = c(9:10, 12:14, 16:17, 19),
                                    gbm.y = 5,
                                    family = "bernoulli",
                                    tree.complexity = 7,
                                    learning.rate = 0.01,
...
ggBRT::ggInfluence(agi_tc7_lr01_nolat)

AGI_int <- gbm.interactions(agi_tc7_lr01_nolat)
AGI_int$rank.list

gbm.plot(agi_tc7_lr01_nolat, nplots = 13, plot.layout = c(3,3), write.title = FALSE) 
```
...
map_pred = predict(agi_rast_2004, agi_tc7_lr01_nolat, type = "response", n.trees = agi_tc7_lr01_nolat$gbm.call$best.trees, na.rm = FALSE) 
...
map_pred = predict(agi_rast_2007, agi_tc7_lr01_nolat, type = "response", n.trees = agi_tc7_lr01_nolat$gbm.call$best.trees, na.rm = FALSE) 
map_pred = crop(map_pred,extent1)
...
map_pred = predict(agi_rast_2009, agi_tc7_lr01_nolat, type = "response", n.trees = agi_tc7_lr01_nolat$gbm.call$best.trees, na.rm = FALSE) 
map_pred = crop(map_pred,extent1)
...
```{r}
#| warning: FALSE
try(do_tc7_lr01_nolat <- dismo::gbm.step(data = dat_train,
                                    gbm.x = c(8:12, 14:18),
                                    gbm.y = 5,
                                    family = "bernoulli",
                                    tree.complexity = 7,
...
ggBRT::ggInfluence(do_tc7_lr01_nolat) 

AGI_int <- gbm.interactions(do_tc7_lr01_nolat)
AGI_int$rank.list

gbm.plot(do_tc7_lr01_nolat, nplots = 13, plot.layout = c(3,3), write.title = FALSE) 
```
...
map_pred = predict(do_rast_2004, do_tc7_lr01_nolat, type = "response", n.trees = do_tc7_lr01_nolat$gbm.call$best.trees, na.rm = FALSE) 
map_pred = crop(map_pred,extent1)
...
map_pred = predict(do_rast_2007, do_tc7_lr01_nolat, type = "response", n.trees = do_tc7_lr01_nolat$gbm.call$best.trees, na.rm = FALSE) 
map_pred = crop(map_pred,extent1)
...
map_pred = predict(do_rast_2009, do_tc7_lr01_nolat, type = "response", n.trees = do_tc7_lr01_nolat$gbm.call$best.trees, na.rm = FALSE) 
map_pred = crop(map_pred,extent1)
...
```{r}
#| warning: FALSE
try(agi_temp_tc7_lr01_nolat <- dismo::gbm.step(data = dat_train,
                                    gbm.x = c(8:10, 12:17, 19),
                                    gbm.y = 5,
                                    family = "bernoulli",
                                    tree.complexity = 7,
                                    learning.rate = 0.01,
...
ggBRT::ggInfluence(agi_temp_tc7_lr01_nolat) 

AGI_int <- gbm.interactions(agi_temp_tc7_lr01_nolat)
AGI_int$rank.list

gbm.plot(agi_temp_tc7_lr01_nolat, nplots = 13, plot.layout = c(3,3), write.title = FALSE) 
```
...
map_pred = predict(agi_temp_rast_2004, agi_temp_tc7_lr01_nolat, type = "response", n.trees = agi_temp_tc7_lr01_nolat$gbm.call$best.trees, na.rm = FALSE) 
map_pred = crop(map_pred,extent1)
...
#| warning: false
   #make HSI plot
agi_temp_rast_2007 <- rast(here("data/enviro/CMEMS/hsi_map/agi-temp_covar2007_spatrast.nc"))

map_pred = predict(agi_temp_rast_2007, agi_temp_tc7_lr01_nolat, type = "response", n.trees = agi_temp_tc7_lr01_nolat$gbm.call$best.trees, na.rm = FALSE) 
map_pred = crop(map_pred,extent1)
...
map_pred = predict(do_rast_2009, agi_temp_tc7_lr01_nolat, type = "response", n.trees = agi_temp_tc7_lr01_nolat$gbm.call$best.trees, na.rm = FALSE) 
map_pred = crop(map_pred,extent1)
